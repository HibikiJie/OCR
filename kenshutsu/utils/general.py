...
from kenshutsu.utils.google_utils import gsutil_getsize
from kenshutsu.utils.metrics import fitness
from kenshutsu.utils.torch_utils import init_torch_seeds
...
def labels_to_image_weights(labels, nc=80, class_weights=np.ones(80)):
    ...
    # index = random.choices(range(n), weights=image_weights, k=1)  # weights image sample
